        ...
        <div className="row">
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-danger card-img-holder text-white">
              <div className="card-body">
                ...
                <h4 className="font-weight-normal mb-3"><Trans>Weekly Sales</Trans> <i className="mdi mdi-chart-line mdi-24px float-end ms-2"></i>
                </h4>
          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-info card-img-holder text-white">
              <div className="card-body">
                <img src={require("../../assets/images/dashboard/circle.png")} className="card-img-absolute" alt="circle" />
                <h4 className="font-weight-normal mb-3"><Trans>Weekly Orders</Trans> <i className="mdi mdi-bookmark-outline mdi-24px float-end ms-2"></i>
                </h4>
          ...
          <div className="col-md-4 stretch-card grid-margin">
            <div className="card bg-gradient-success card-img-holder text-white">
              <div className="card-body">
                <img src={require("../../assets/images/dashboard/circle.png")} className="card-img-absolute" alt="circle" />
                <h4 className="font-weight-normal mb-3"><Trans>Visitors Online</Trans> <i className="mdi mdi-diamond mdi-24px float-end ms-2"></i>
                </h4>
            ...
            <div className="card">
              <div className="card-body">
                <div className="clearfix mb-4">
                  <h4 className="card-title float-start"><Trans>Visit And Sales Statistics</Trans></h4>
                ...
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face1.jpg")} className="ms-2" alt="face" /> <Trans>David Grey</Trans> </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face2.jpg")} className="ms-2" alt="face" /> <Trans>Stella Johnson</Trans> </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face3.jpg")} className="ms-2" alt="face" /> <Trans>Marina Michel</Trans> </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face4.jpg")} className="ms-2" alt="face" /> <Trans>John Doe</Trans> </td>
              ...
              <div className="card-body">
                ...
                <div className="d-flex">
                  ...
                  <div className="d-flex align-items-center text-muted font-weight-light">
                    <i className="mdi mdi-clock icon-sm ms-2"></i>
                ...
                <div className="d-flex mt-5 align-items-start">
                  <img src={require("../../assets/images/faces/face3.jpg")} className="img-sm rounded-circle ms-3" alt="face" />
                  <div className="mb-0 flex-grow">
                    <h5 className="me-2 mb-2"><Trans>School Website</Trans> - <Trans>Authentication Module</Trans>.</h5>
