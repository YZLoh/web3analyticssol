                ...
                <div className="clearfix">
                  ...
                  <div className="float-end">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-medium text-right mb-0 text-dark">$6,560</h3>
                    </div>
                  </div>
                </div>
            ...
            <div className="card card-statistics">
              <div className="card-body pb-0">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <h6 className="text-success font-weight-semibold ms-2">+876</h6>
                </div>
          ...
          <div className="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
            <div className="card card-statistics">
              <div className="card-body pb-0">
                ...
                <div className="d-flex align-items-center">
                  <h4 className="font-weight-semibold text-dark">$65,650</h4>
                  <h6 className="text-danger font-weight-semibold ms-2">-43</h6>
                </div>
            ...
            <div className="card card-statistics">
              <div className="card-body pb-0">
                ...
                <div className="d-flex align-items-center">
                  ...
                  <h6 className="text-success font-weight-semibold ms-2">+23</h6>
                </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        <p className="card-text mb-0 text-dark">New Users</p>
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-medium text-dark">65,650</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        <p className="card-text mb-0 text-dark">New Feedbacks</p>
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-medium text-dark">32,604</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        ...
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-medium text-dark">17,583</h3>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card-col col-xl-3 col-lg-3 col-md-3 col-6">
                  <div className="card-body">
                    <div className="d-flex align-items-center justify-content-center flex-column flex-sm-row">
                      ...
                      <div className="wrapper text-center text-sm-left">
                        <p className="card-text mb-0 text-dark">Total Sales</p>
                        <div className="fluid-container">
                          <h3 className="mb-0 font-weight-medium text-dark">61,119</h3>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-xl-flex flex-row">
                  ...
                  <div className="ms-xl-3 mt-2 mt-xl-0">
                    <h6 className="text-dark">Thomas Edison</h6>
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-xl-flex flex-row">
                  ...
                  <div className="ms-xl-3 mt-2 mt-xl-0">
                    <h6 className="text-dark">Edward</h6>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <p className="mb-2 text-dark">Unpaid Invoices</p>
                <div className="d-flex align-items-center">
                  <h1 className="font-weight-medium mb-2 text-dark">$2,156</h1>
                  <h5 className="font-weight-medium text-success ms-2">−14.2%</h5>
                </div>
                <div className="d-flex align-items-center">
                  <div className="bg-success dot-indicator"></div>
                  <p className="text-muted mb-0 ms-2">This month unpaid invoices $567</p>
                </div>
              </div>
            </div>
          </div>
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <p className="mb-2 text-dark">Gross volume</p>
                <div className="d-flex align-items-center">
                  <h1 className="font-weight-medium mb-2 text-dark">$1,520</h1>
                  <h5 className="font-weight-medium text-success ms-2">+20.7%</h5>
                </div>
                <div className="d-flex align-items-center">
                  <div className="bg-primary dot-indicator"></div>
                  <p className="text-muted mb-0 ms-2">Next payout -23 aug- $233</p>
                </div>
              </div>
            </div>
          </div>
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card aligner-wrapper">
              <div className="card-body">
                ...
                <p className="text-dark mb-2">Average revenue</p>
                <div className="d-flex align-items-center">
                  <h1 className="font-weight-medium mb-2 text-dark">$6.60</h1>
                  <h5 className="font-weight-medium text-success ms-2">+296.6%</h5>
                </div>
                <div className="d-flex align-items-center">
                  <div className="bg-danger dot-indicator"></div>
                  <p className="text-muted mb-0 ms-2">Payout for next week $100 </p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="list-item">
                  ...
                  <div className="content">
                    <div className="d-flex align-items-center">
                      ...
                      <small className="time ms-3 d-none d-sm-block">08.34 AM</small>
                ...
                <div className="list-item">
                  ...
                  <div className="content">
                    <div className="d-flex align-items-center">
                      ...
                      <small className="time ms-3 d-none d-sm-block">12.56 PM</small>
                      <div className="ms-auto">
                        <Rating 
                          initialRating="2"
                          emptySymbol={<i className="mdi mdi-star text-muted mr-1" style={{fontSize:'20px', marginRight: '2px', display:'block'}}></i>}
                ...
                <div className="list-item">
                  ...
                  <div className="content">
                    <div className="d-flex align-items-center">
                      ...
                      <small className="time ms-3 d-none d-sm-block">09.24 AM</small>
                      <div className="ms-auto">
                        <Rating 
                          initialRating="3"
                          emptySymbol={<i className="mdi mdi-star text-muted mr-1" style={{fontSize:'20px', marginRight: '2px', display:'block'}}></i>}
                ...
                <div className="list-item">
                  ...
                  <div className="content">
                    <div className="d-flex align-items-center">
                      ...
                      <small className="time ms-3 d-none d-sm-block">5.12 AM</small>
                      <div className="ms-auto">
                        <Rating 
                          initialRating="4"
                          emptySymbol={<i className="mdi mdi-star text-muted mr-1" style={{fontSize:'20px', marginRight: '2px', display:'block'}}></i>}
                ...
                <div className="list-item">
                  ...
                  <div className="content">
                    <div className="d-flex align-items-center">
                      ...
                      <small className="time ms-3 d-none d-sm-block">10.00 AM</small>
                      <div className="ms-auto">
                        <Rating 
                          initialRating="5"
                          emptySymbol={<i className="mdi mdi-star text-muted mr-1" style={{fontSize:'20px', marginRight: '2px', display:'block'}}></i>}
              ...
              <div className="card-body">
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ms-3">
                    <h6 className="ms-1 mb-1 text-dark">Stella Davidson</h6>
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ms-3">
                    <h6 className="ms-1 mb-1 text-dark">Daniel Russel</h6>
                    <small className="text-muted mb-0">
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ms-3">
                    <h6 className="ms-1 mb-1 text-dark">Bruno King</h6>
                    <small className="text-muted mb-0">
                ...
                <div className="wrapper d-flex align-items-center py-2 border-bottom">
                  ...
                  <div className="wrapper ms-3">
                    <h6 className="ms-1 mb-1 text-dark">David Moore</h6>
                    <small className="text-muted mb-0">
                ...
                <div className="wrapper d-flex align-items-center pt-2">
                  ...
                  <div className="wrapper ms-3">
                    <h6 className="ms-1 mb-1 text-dark">Rafell John</h6>
                    <small className="text-muted mb-0">
            ...
            <div className="card">
              <div className="card-body">
                ...
                <ul className="bullet-line-list">
                  <li>
                    <h6 className="text-dark">User confirmation</h6>
                    <p>Lorem Ipsum is simply dummy text of the printing</p>
                    <p className="text-muted">
                      <i className="mdi mdi-clock"></i> 7 months ago.</p>
                  </li>
                  <li>
                    <h6 className="text-dark">Continuous evaluation</h6>
                    <p>Lorem Ipsum is simply dummy text of the printing</p>
                    <p className="text-muted">
                      <i className="mdi mdi-clock"></i> 7 months ago.</p>
                  </li>
                  <li>
                    <h6 className="text-dark">Promotion</h6>
                    <p>Lorem Ipsum is simply dummy text of the printing</p>
                    <p className="text-muted">
                      <i className="mdi mdi-clock"></i> 7 months ago.</p>
                  </li>
