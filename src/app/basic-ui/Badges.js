                  ...
                  <table className="table mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-danger"><i className="mdi mdi-email me-2"></i>12</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Icon With Text</td>
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-success">12<i className="mdi mdi-email ms-2"></i></div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Icon Badge</td>
                ...
                <div className="template-demo">
                  <table className="table mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td className="pl-0">Primary label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-primary">Primary</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Secondary label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-secondary">Secondary</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Info label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-info">Info</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Danger label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-danger">Danger</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Success label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-success">Success</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Warning label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-warning">Warning</div></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="template-demo">
                  <table className="table mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td className="pl-0">Primary label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-primary badge-pill">Primary</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Secondary label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-secondary badge-pill">Secondary</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Info label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-info badge-pill">Info</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Danger label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-danger badge-pill">Danger</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Success label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-success badge-pill">Success</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Warning label</td>
                        <td className="pr-0 text-right"><div className="badge badge-gradient-warning badge-pill">Warning</div></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
