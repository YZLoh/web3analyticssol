          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <nav className="navbar navbar-expand-lg">
                  <a className="navbar-brand" href="!#" onClick={event => event.preventDefault()}><img src={ require( "../../assets/images/logo.png") } alt="logo" /></a>
            ...
            <div className="row py-sm-5 py-0">
              <div className="col-lg-7 banner-content">
                <h1 className="me-2 text-white"> All you need for creating dashboard UI and complex web interfaces. </h1>
                <h3 className="font-weight-light text-white pt-2 pb-5"> Star Admin Template </h3>
                <div className="my-5">
                  <button className="btn btn-primary btn-lg me-2 mb-3">VIEW ALL DEMO</button>
                  <button className="btn btn-danger btn-lg ms-2 mb-3">BUY NOW</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-sm-4 pb-3">
                <div className="card card-icon-top">
                  <div className="card-body text-center">
                    <img src={ require( "../../assets/images/samples/angular-4.png" )}alt="sample" className="card-icon" />
                    <h4>Angular 5</h4>
            ...
            <div className="row mt-5 mb-5">
              <div className="col-md-8 mx-auto py-5 text-center">
                ...
                <h4 className="font-weight-light"> This template comes with AngularJs and HTML5/jQuery version, which helps to choose the best dashboard solution to fit your project needs. </h4>
              </div>
            </div>
            <div className="row mb-5">
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/dashboard.png")} alt="sample" />
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/widgets.png")} alt="sapmle" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/modal.png")} alt="demo" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/e-commerce.png")} alt="demo" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/email.png")} alt="demo" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/charts.png")} alt="demo" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/editors.png")} alt="demo" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/forms.png")} alt="demo" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="col-md-4 grid-margin">
                <div className="m-3">
                  <div className="card card-item-preview">
                    <img className="card-img-top" src={ require( "../../assets/images/samples/popup.png")} alt="demo" />
                    <div className="card-body py-3 border-top">
              ...
              <div className="row">
                <div className="col-lg-4">
                  ...
                  <div className="d-flex pt-5 pb-5">
                    ...
                    <div className="social-icons bg-secondary text-white"><span className="mdi mdi-pinterest"></span></div>
                    <div className="social-icons bg-danger text-white"><span className="mdi mdi-dribbble"></span></div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-8">
                <h4 className="mt-3">Copyright © 2018 <a href="!#" onClick={event => event.preventDefault()}>bootstrapdash</a>. All rights reserved.</h4>
              </div>
