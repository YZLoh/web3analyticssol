                ...
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face1.jpg")} className="me-2" alt="face" /> David Grey </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face2.jpg")} className="me-2" alt="face" /> Stella Johnson </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face3.jpg")} className="me-2" alt="face" /> Marina Michel </td>
                      ...
                      <tr>
                        <td>
                          <img src={require("../../assets/images/faces/face4.jpg")} className="me-2" alt="face" /> John Doe </td>
